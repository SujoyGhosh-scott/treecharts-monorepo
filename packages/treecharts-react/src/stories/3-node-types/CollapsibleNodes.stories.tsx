...
const companyOverviewData = {
  ...
  description:
    "Global technology corporation specializing in software development, innovation, and digital transformation solutions for enterprises worldwide",
  collapsibleState: { expanded: true },
  child: [
    {
      value: "Engineering Division",
      description:
        "World-class engineering teams focused on building scalable, robust software solutions using cutting-edge technologies and best practices",
      collapsibleState: { expanded: false },
      child: [
        {
          value: "Frontend Teams",
          description:
            "Specialized teams creating exceptional user experiences using React, Vue, Angular, and modern web technologies",
          collapsibleState: { expanded: false },
          child: [],
        },
        {
          value: "Backend Teams",
          description:
            "Server-side development experts building APIs, microservices, and distributed systems with high performance and reliability",
          collapsibleState: { expanded: false },
          child: [],
        },
        {
          value: "DevOps Teams",
          description:
            "Infrastructure and deployment specialists ensuring smooth CI/CD pipelines, monitoring, and cloud operations",
          collapsibleState: { expanded: false },
          child: [],
        },
      ],
    },
    {
      ...
      description:
        "Strategic product management teams driving innovation, user research, and market-fit validation for all company products",
      collapsibleState: { expanded: false },
      child: [
        {
          value: "Product Strategy",
          description:
            "Long-term product vision, roadmap planning, and competitive analysis to guide product development",
          collapsibleState: { expanded: false },
          child: [],
        },
        {
          ...
          description:
            "UX research, design systems, and user interface design ensuring optimal user satisfaction and engagement",
          collapsibleState: { expanded: false },
          child: [],
        },
      ],
    },
    {
      ...
      description:
        "Supporting business functions including finance, human resources, legal, and administrative operations",
      collapsibleState: { expanded: false },
      child: [],
    },
  ],
...
export const InteractiveOrganizationChart: Story = {
  args: {
    ...
    titleConfig: {
      ...
      description:
        "Click the ▼ buttons to expand descriptions and explore the organization structure",
    },
    width: "100%",
    height: "600px",
  },
...
const projectPlanData = {
  ...
  description:
    "Complete product launch timeline with detailed phases, deliverables, and milestone requirements for successful market introduction",
  collapsibleState: { expanded: true },
  child: [
    {
      value: "Phase 1: Research & Planning",
      description:
        "Market research, competitive analysis, user interviews, technical feasibility studies, and comprehensive project planning with resource allocation",
      collapsibleState: { expanded: false },
      child: [
        {
          value: "Market Research",
          description:
            "Comprehensive market analysis including target audience identification, competitor assessment, pricing strategies, and market size evaluation",
          collapsibleState: { expanded: false },
          child: [],
        },
        {
          ...
          description:
            "Architecture design, technology stack selection, infrastructure requirements, and technical risk assessment",
          collapsibleState: { expanded: false },
          child: [],
        },
      ],
    },
    {
      ...
      description:
        "Agile development process with regular sprints, code reviews, testing integration, and continuous delivery pipeline setup",
      collapsibleState: { expanded: false },
      child: [
        {
          value: "MVP Development",
          description:
            "Minimum viable product development focusing on core features, basic functionality, and user feedback integration",
          collapsibleState: { expanded: false },
          child: [],
        },
        {
    ...
    },
    {
      ...
      description:
        "Comprehensive testing including unit tests, integration tests, user acceptance testing, and coordinated launch campaign execution",
      collapsibleState: { expanded: false },
      child: [
        {
          value: "Quality Assurance",
          description:
            "Thorough testing procedures including automated testing, manual testing, performance testing, and security audits",
          collapsibleState: { expanded: false },
          child: [],
        },
        {
          ...
          description:
            "Marketing campaign execution, press releases, social media promotion, and customer onboarding process",
          collapsibleState: { expanded: false },
          child: [],
        },
      ],
...
export const ProjectPlanningChart: Story = {
  args: {
    ...
    titleConfig: {
      ...
      description:
        "Explore project phases by expanding sections to see detailed requirements and deliverables",
    },
    width: "100%",
    height: "700px",
  },
...
const knowledgeBaseData = {
  ...
  description:
    "Comprehensive documentation covering all aspects of product usage, configuration, troubleshooting, and advanced features",
  collapsibleState: { expanded: false },
  child: [
    {
      value: "Getting Started Guide",
      description:
        "Step-by-step instructions for new users including account setup, initial configuration, basic features overview, and first-time user tutorials",
      collapsibleState: { expanded: false },
      child: [
        {
          value: "Installation",
          description:
            "Detailed installation instructions for different operating systems, requirements, dependencies, and troubleshooting common installation issues",
          collapsibleState: { expanded: false },
          child: [],
        },
        {
          value: "Configuration",
          description:
            "Initial setup procedures, environment configuration, user preferences, and customization options for optimal user experience",
          collapsibleState: { expanded: false },
          child: [],
        },
      ],
    },
    {
      ...
      description:
        "In-depth documentation for power users covering advanced functionality, integrations, customizations, and expert-level configurations",
      collapsibleState: { expanded: false },
      child: [
        {
          value: "API Documentation",
          description:
            "Complete API reference including endpoints, authentication, request/response formats, rate limiting, and code examples",
          collapsibleState: { expanded: false },
          child: [],
        },
        {
          value: "Integrations",
          description:
            "Third-party integrations, webhook configurations, plugin development, and custom extension creation guidelines",
          collapsibleState: { expanded: false },
          child: [],
        },
      ],
    },
    {
      ...
      description:
        "Common issues, error messages, diagnostic procedures, and solutions for technical problems users might encounter",
      collapsibleState: { expanded: false },
      child: [],
    },
  ],
...
export const DocumentationHierarchy: Story = {
  args: {
    ...
    titleConfig: {
      ...
      description:
        "Navigate through documentation sections by expanding relevant topics",
    },
    width: "100%",
    height: "600px",
  },
  ...
  child: [
    {
      ...
      description:
        "This node starts collapsed and can be expanded by clicking the button",
      collapsibleState: { expanded: false },
      child: [],
    },
    {
      ...
      description:
        "This node starts expanded to show the description immediately",
      collapsibleState: { expanded: true },
      child: [],
    },
    {
      ...
      child: [
        ...
        },
        {
          value: "Child B",
          description:
            "Each child maintains its own expansion state separately",
          collapsibleState: { expanded: false },
          child: [],
        },
      ],
...
export const StateManagementDemo: Story = {
  args: {
    ...
    titleConfig: {
      ...
      description:
        "Example showing different initial states and independent state control",
    },
    width: "100%",
    height: "500px",
  },
